...
export default function BlogsClient({ fallbackBlogs, fallbackBrands, fallbackProducts }) {
    ...
    const { data: brandsRes } = useSWR(['/brands', {}], fetcher, { 
        fallbackData: fallbackBrands, revalidateOnFocus: false, revalidateOnMount: false 
    });
    
    const { data: productsRes } = useSWR(['/products', {}], fetcher, { 
        fallbackData: fallbackProducts, revalidateOnFocus: false, revalidateOnMount: false 
    });
    ...
    const { data: blogsRes, isLoading } = useSWR(['/blogs', params], fetcher, {
        fallbackData: fallbackBlogs, revalidateOnFocus: false, revalidateOnMount: false
    });
