...
async function getLandingData() {
    ...
    try {
        const [productsRes, offersRes, brandsRes] = await Promise.all([
            fetch(`${baseURL}/products?per_page=100`, { next: { tags: ['products'], revalidate: 60 } }),
            fetch(`${baseURL}/products?offers=true&per_page=20`, { next: { tags: ['products'], revalidate: 60 } }),
            fetch(`${baseURL}/brands`, { next: { tags: ['products'], revalidate: 60 } })
        ]);
